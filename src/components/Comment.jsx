...
export function Comment({content, WhenDeleteComment}) {
    ...
    return (
        <div className={styles.comment}>
            <Avatar hasBorder={false} src="https://avatars.githubusercontent.com/u/94193637?v=4" alt="" />
                ...
                <div className={styles.commentContent}>
                    <header>
                        <div className={styles.authorAndTime}>
                            ...
                            <time title='Publicado 11 de julho ás 16:29' dateTime='2022-05-11 04:29:3'>Cerca de 1h atrás</time>
                        </div>
